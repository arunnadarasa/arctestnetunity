...
public class Web3AuthOptions {
    ...
    public string sdkUrl {
        get {
            if (buildEnv == Web3Auth.BuildEnv.STAGING)
                return "https://staging-auth.web3auth.io";
    ...
    /// <summary>KrumpKraft: hosted v10 Google auth connection id (e.g. w3a-google). Must match dashboard Social Connections.</summary>
    public string defaultGoogleAuthConnectionId { get; set; }
}